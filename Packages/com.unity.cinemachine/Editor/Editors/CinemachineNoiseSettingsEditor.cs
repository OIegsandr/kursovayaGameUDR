        ...
        public override void OnInspectorGUI()
        {
            ...
            if (mRotChannels == null)
                mRotChannels = SetupReorderableLists(
                    serializedObject.FindProperty(() => Target.tOrientationNoise), mRotlabels);
            ...
            if (Event.current.type == EventType.Repaint)
            {
                mSampleCacheRot.SnapshotSample(r.size, Target.tOrientationNoise, mNoiseOffset, mAnimatedPreview);
