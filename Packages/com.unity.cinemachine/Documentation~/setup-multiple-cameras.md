...
2. In the Unity menu, select **GameObject** > **Cinemachine** > **Cinemachine Camera**.
   ...
   Unity adds a new GameObject with a [Cinemachine Camera](CinemachineCamera.md) component and a Transform that matches the latest position and tOrientation of the Scene view camera.
