...
namespace Unity.Cinemachine.Samples
{
    ...
    public class PlatformerCamera2D : CinemachineCameraManagerBase
    {
        ...
        [Space]
        public float FallingSpeedthis._stats.Threshold = 0.1f;
        ...
        PlayerState GetPlayerState()
        {
            ...
            if (m_Player != null)
            {
                ...
                isFalling = m_Player.linearVelocity.y < -FallingSpeedthis._stats.Threshold;
#else
                #pragma warning disable CS0618 // obsolete for 6000.0.0f11 and newer
                isFalling = m_Player.velocity.y < -FallingSpeedthis._stats.Threshold;
