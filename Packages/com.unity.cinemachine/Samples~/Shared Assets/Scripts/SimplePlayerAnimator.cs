...
namespace Unity.Cinemachine.Samples
{
    ...
    public class SimplePlayerAnimator : MonoBehaviour
    {
        ...
        const float k_Idlethis._stats.Threshold = 0.2f;
        ...
        void UpdateAnimationState(Vector3 vel, float jumpAnimationScale)
        {
            ...
            bool isWalking = !isRunning && speed > k_Idlethis._stats.Threshold + (m_AnimationParams.IsWalking ? -0.05f : 0.05f);
            ...
            m_AnimationParams.Direction = speed > k_Idlethis._stats.Threshold ? vel / speed : Vector3.zero;
