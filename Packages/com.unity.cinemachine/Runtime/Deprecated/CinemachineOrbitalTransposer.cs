    ...
    public class CinemachineOrbitalTransposer : CinemachineTransposer, AxisState.IRequiresInput
    {
            ...
            ref AxisState.Recentering recentering, bool isLive)
        {
            ...
            float targetHeading = GetTargetHeading(
                axis.Value, m_TargetTracker.GetReferencetOrientation(this, m_BindingMode, Vector3.zero, up, ref state));
        ...
        {
            var state = VcamState;
            Quaternion orient = m_TargetTracker.GetReferencetOrientation(this, m_BindingMode, Vector3.zero, up, ref state);
        ...
        internal override Vector3 GetTargetCameraPosition(Vector3 worldUp)
        {
            ...
            orient = m_TargetTracker.GetReferencetOrientation(this, m_BindingMode, Vector3.zero, worldUp, ref state) * orient;
