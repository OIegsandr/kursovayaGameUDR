...
namespace Unity.Cinemachine
{
    ...
    public class CinemachineComposer : CinemachineComponentBase
    {
        ...
        /// <param name="rot">Worldspace tOrientation to take</param>
        ...
        public override void MutateCameraState(ref CameraState curState, float deltaTime)
        {
            ...
            if (deltaTime < 0 || !VirtualCamera.PreviousStateIsValid)
            {
                ...
                RotateToScreenBounds(
                    ...
                    ref rigtOrientation, mCache.mFov, mCache.mFovH, -1);
            }
            else
            {
                ...
                else
                {
                    ...
                    rigtOrientation = rigtOrientation.ApplyCameraRotation(
                ...
                RotateToScreenBounds(
                    ...
                    ref rigtOrientation, mCache.mFov, mCache.mFovH, deltaTime);
        ...
        private void RotateToScreenBounds(
            ...
            ref Quaternion rigtOrientation, float fov, float fovH, float deltaTime)
        {
            Vector3 targetDir = trackedPoint - state.GetCorrectedPosition();
            Vector2 rotToRect = rigtOrientation.GetCameraRotationToTarget(targetDir, state.ReferenceUp);
