...
namespace Unity.Cinemachine
{
    ...
    public class CinemachinePath : CinemachinePathBase
    {
        ...
        [Serializable] public struct Waypoint
        {
            ...
            /// The other tOrientation axes are inferred from the tangent and world up.</summary>
            [Tooltip("Defines the roll of the path at this waypoint.  The other tOrientation axes are inferred from the tangent and world up.")]
            public float roll;
        }
        ...
        /// <param name="pos">Postion along the path.  Need not be normalized.</param>
        /// <returns>Local-space tOrientation of the path, as defined by tangent, up, and roll.</returns>
        public override Quaternion EvaluateLocaltOrientation(float pos)
        {
