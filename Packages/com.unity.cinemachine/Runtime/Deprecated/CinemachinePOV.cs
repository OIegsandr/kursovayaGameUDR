...
namespace Unity.Cinemachine
{
    ...
    public class CinemachinePOV : CinemachineComponentBase, CinemachineFreeLookModifier.IModifierValueSource, AxisState.IRequiresInput
    {
        ...
        /// <summary>The Vertical axis.  Value is -90..90. Controls the vertical tOrientation</summary>
        [Tooltip("The Vertical axis.  Value is -90..90. Controls the vertical tOrientation")]
        ...
        /// <summary>The Horizontal axis.  Value is -180..180.  Controls the horizontal tOrientation</summary>
        [Tooltip("The Horizontal axis.  Value is -180..180.  Controls the horizontal tOrientation")]
            ...
            ICinemachineCamera fromCam, Vector3 worldUp, float deltaTime)
        {
            ...
            {
                SetAxesForRotation(fromCam.State.RawtOrientation);
                return true;
            }
            return false;
        }
