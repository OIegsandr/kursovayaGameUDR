...
namespace Unity.Cinemachine
{
        ...
        , CinemachineFreeLookModifier.IModifiableComposition
    {
        ...
        /// <summary>FramingTransposer algorithm takes camera tOrientation as input,
            ...
            ICinemachineCamera fromCam, Vector3 worldUp, float deltaTime)
        {
                ...
                && !CinemachineCore.IsLiveInBlend(VirtualCamera))
            {
                ...
                m_PreviousRotation = fromCam.State.RawtOrientation;
        ...
        public override void MutateCameraState(ref CameraState curState, float deltaTime)
        {
            ...
            if (!previousStateIsValid)
            {
                ...
                m_PreviousRotation = curState.RawtOrientation;
                ...
                if (!m_InheritingPosition && CenterOnActivate)
                {
                    m_PreviousCameraPosition = FollowTargetPosition
                        + (curState.RawtOrientation * Vector3.back) * CameraDistance;
                }
            }
            if (!IsValid)
            {
            ...
            // Allow undamped camera tOrientation and distance change
            var localToWorld = curState.RawtOrientation;
            if (previousStateIsValid)
            {
