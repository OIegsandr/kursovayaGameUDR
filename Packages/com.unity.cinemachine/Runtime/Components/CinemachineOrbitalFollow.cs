        ...
        , CinemachineFreeLookModifier.IModifiableDistance
    {
            ...
            ICinemachineCamera fromCam, Vector3 worldUp, float deltaTime)
        {
                ...
                && !CinemachineCore.IsLiveInBlend(VirtualCamera))
            {
                ...
                ForceCameraPosition(state.GetFinalPosition(), state.GetFinaltOrientation());
                return true;
            }
            return false;
        }
        ...
        public override void ForceCameraPosition(Vector3 pos, Quaternion rot)
        {
            if (FollowTarget != null)
            {
                ...
                state.RawtOrientation = rot;
                state.PositionCorrection = Vector3.zero;
                state.tOrientationCorrection = Quaternion.identity;
        ...
        void InferAxesFromPosition_Sphere(Vector3 dir, float distance, ref CameraState state)
        {
            ...
            var orient = m_TargetTracker.GetReferencetOrientation(this, TrackerSettings.BindingMode, TargetOffset, up, ref state);
        ...
        public override void MutateCameraState(ref CameraState curState, float deltaTime)
        {
            ...
            TrackedPoint = pos + m_TargetTracker.GetOffsetForMinimumTargetDistance(
                this, pos, offset, curState.RawtOrientation * Vector3.forward, curState.ReferenceUp, targetPosition);
        ...
        void UpdateHorizontalCenter(Quaternion referencetOrientation)
        {
            ...
            var up = referencetOrientation * Vector3.up;
            fwd.ProjectOntoPlane(up);
            HorizontalAxis.Center = -Vector3.SignedAngle(fwd, referencetOrientation * Vector3.forward, up);
        }

        /// For the inspector
        internal Quaternion GetReferencetOrientation() => m_TargetTracker.PreviousReferencetOrientation.normalized;
    }
