...
namespace Unity.Cinemachine
{
        ...
        : CinemachineComponentBase, CinemachineFreeLookModifier.IModifiableNoise
    {
        ...
        public override void MutateCameraState(ref CameraState curState, float deltaTime)
        {
            ...
            curState.PositionCorrection += curState.GetCorrectedtOrientation() * NoiseSettings.GetCombinedFilterResults(
            ...
            Quaternion rotNoise = Quaternion.Euler(NoiseSettings.GetCombinedFilterResults(
                    NoiseProfile.tOrientationNoise, m_NoiseTime, m_NoiseOffsets) * AmplitudeGain);
            if (PivotOffset != Vector3.zero)
            {
                ...
                curState.PositionCorrection += curState.GetCorrectedtOrientation() * m.MultiplyPoint(Vector3.zero);
            }
            curState.tOrientationCorrection = curState.tOrientationCorrection * rotNoise;
        }
