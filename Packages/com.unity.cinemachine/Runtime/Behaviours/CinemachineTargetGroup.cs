...
namespace Unity.Cinemachine
{
    ...
    public class CinemachineTargetGroup : MonoBehaviour, ICinemachineTargetGroup
    {
        ...
        /// <summary>How the group's tOrientation is calculated</summary>
        public enum RotationModes
        {
            /// <summary>Manually set in the group's transform</summary>
            Manual,
            /// <summary>Weighted average of the tOrientation of its members.</summary>
            GroupAverage
        }

        /// <summary>How the group's tOrientation is calculated</summary>
        [Tooltip("How the group's rotation is calculated.  Select Manual to use the value in the group's transform, "
            + "and GroupAverage for a weighted average of the tOrientations of the members.")]
        ...
        /// contribute to the group's average position, tOrientation, and size</summary>
        [NoSaveDuringPlay]
        [Tooltip("The target objects, together with their weights and radii, that will contribute to the "
            + "group's average position, tOrientation, and size.")]
        ...
        public void DoUpdate()
        {
            ...
            switch (RotationMode)
            {
                ...
                case RotationModes.GroupAverage:
                    transform.rotation = CalculateAveragetOrientation();
                    break;
            }
        }
        ...
        // Assumes that UpdateMemberValidity() has been called
        Quaternion CalculateAveragetOrientation()
        {
