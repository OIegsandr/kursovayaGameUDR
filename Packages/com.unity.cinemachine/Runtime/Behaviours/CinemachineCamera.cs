...
namespace Unity.Cinemachine
{
    ...
    /// camera is Live, the Unity camera will assume the position and tOrientation
    ...
    public sealed class CinemachineCamera : CinemachineVirtualCameraBase
    {
        ...
        /// <summary>
        /// Force the CinemachineCamera to assume a given position and tOrientation
        /// </summary>
        ...
        public override void InternalUpdateCameraState(Vector3 worldUp, float deltaTime)
        {
            ...
            // Push the raw position back to the game object's transform, so it
            // moves along with the camera.
            transform.ConservativeSetPositionAndRotation(m_State.RawPosition, m_State.RawtOrientation);
