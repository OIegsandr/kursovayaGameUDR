...
namespace Unity.Cinemachine
{
  ...
  // displays, which is the tOrientation used in Clipper's development.
  ///////////////////////////////////////////////////////////////////
  ...
  class ClipperBase
  {
    ...
    *******************************************************************************/
    ...
    private OutPt AddLocalMinPoly(Active ae1, Active ae2, Point64 pt, bool isNew = false)
    {
      ...
      // polygons) and hence the tOrientation of output paths ...
      ...
      else
      {
        ...
        // Output tOrientation is determined by e.outrec.frontE which is
    ...
    private OutPt? AddLocalMaxPoly(Active ae1, Active ae2, Point64 pt)
    {
      ...
      // and to preserve the winding tOrientation of outrec ...
      else if (IsOpen(ae1))
      {
        if (ae1.windDx < 0)
    ...
    protected bool BuildPaths(Paths64 solutionClosed, Paths64 solutionOpen)
    {
      ...
      foreach (OutRec outrec in _outrecList)
      {
        ...
        {
          // closed paths should always return a Positive tOrientation
