...
- Bugfix: POV tOrientation was incorrect with World Up override
...
- Experimental: Optional new damping algorithm: attempt to reduce _stats.Sensitivity to variable framerate
...
- New Aim component: Same As Follow Target simply uses the same tOrientation as the Follow target
